...
INSERT INTO timeline_entries (year, title, description, category, key_figures, order_index) VALUES
(1975, 'Founding of Maliyadeva Basketball [Replace Record]', 'Initial courts established at Maliyadeva College campus. [Verified history to be added via admin panel].', 'Founding', 'Founding Pioneers', 1),
...
INSERT INTO achievements (title, year, tournament, category, position, description, team_name, captain, coach, is_featured) VALUES
('All-Island Schools Championship [Replace Record]', 1998, 'All-Island Senior Championship', 'Island Wide', 'Champions', 'Historic victory securing national top rank for Maliyadeva College. [Verified records to be updated].', 'Devans Senior First V', '[Captain Name]', '[Coach Name]', TRUE),
('Provincial Schools Trophy [Replace Record]', 2006, 'Wayamba Provincial Tournament', 'Provincial', 'Champions', 'Undefeated streak throughout the provincial tournament series.', 'Devans Senior Team', '[Captain Name]', '[Coach Name]', TRUE),
('Triangular Alumni Shield [Replace Record]', 2018, 'Annual Alumni Triangular Tournament', 'Alumni', 'Champions', 'Celebrating brotherhood and competitive excellence among old boys.', 'Devans Alumni Squad', '[Captain Name]', '[Coach Name]', FALSE);

-- 6. GALLERY IMAGES (Editable Placeholders)
INSERT INTO gallery_images (title, caption, image_url, year, category, is_featured) VALUES
('1998 Championship Team Photo [Replace Record]', 'The 1998 All-Island winning squad celebrating on home court.', 'https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&w=1200&q=80', 1998, 'Teams', TRUE),
('Historic Court Action [Replace Record]', 'Fierce competition during inter-school finals.', 'https://images.unsplash.com/photo-1519766304817-4f37bda74a29?auto=format&fit=crop&w=1200&q=80', 2004, 'Matches', TRUE),
('Trophy Presentation [Replace Record]', 'Captains lifting the championship shield.', 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80', 2012, 'Trophies', TRUE),
('Alumni Reunion Gathering [Replace Record]', 'Generations of Devans basketball players reuniting at Maliyadeva College.', 'https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&w=1200&q=80', 2022, 'Reunions', FALSE);

-- 7. STORIES & MEMORIES (Editable Placeholders)
INSERT INTO stories (title, author, generation_name, story, date, status) VALUES
('The Final Quarter of 1998 [Replace Record]', 'Sample Old Boy Author [Replace]', '1990s Champions', 'Down by 4 points with 30 seconds on the clock, our captain called a time-out. What followed was unforgettable. [Verified memory to be added via submission or admin].', '2023-10-15', 'Approved'),
('Brotherhood Beyond the Court [Replace Record]', 'Sample Alumni Member [Replace]', '2000s Renaissance', 'Maliyadeva basketball taught us resilience, respect for our seniors, and a bond that lasts a lifetime.', '2024-02-20', 'Approved');
...
('Devans Basketball Alumni Reunion & Match 2026', 'Annual gathering of former Maliyadeva basketball players across all generations featuring friendly games, dinner, and archive exhibition.', '2026-11-20', '03:00 PM', 'Maliyadeva College Basketball Court, Kurunegala', 'Upcoming');
