...
export default function Navbar({ settings }) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled ? 'bg-devan-dark/95 backdrop-blur-md py-3 border-b border-devan-gold/20 shadow-xl' : 'bg-gradient-to-b from-devan-dark/95 via-devan-dark/60 to-transparent py-5'
    }`}>
